...
| /config/changes/config_change_<nums> | {<br>    "version": 2,<br>    "entity_path": "topics/xxxxxx"<br>} | 记录所有配置变更                                |
| /config/clients |  |                                         |
| /config/topics/__consumer_offsets | {<br>    "version": 1,<br>    "config":<br>    {<br>        "segment.bytes": "104857600",<br>        "compression.type": "producer",<br>        "cleanup.policy": "compact"<br>    }<br>} |                                         |
